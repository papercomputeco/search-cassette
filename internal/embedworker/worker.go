...
// the bounded span-embedding pass (see internal/spanembed) on its own
// interval, inside the search cassette — split out of tapes' derive
// worker so that embedding NEVER blocks derivation.
//
